...
> 📄 本文档 1294 行 · 12 章节 · 整理于 2026-08-23

| # | 章节 |
|---:|---|
| 一 | [概述](#一概述) |
| 二 | [仓库结构](#二仓库结构) |
| 三 | [核心基础库 MY_!Base](#三核心基础库-my_base) |
| 四 | [jx3dat 文件格式与加密机制](#四jx3dat-文件格式与加密机制) |
| 五 | [运行时生成的数据文件详解](#五运行时生成的数据文件详解) |
| 六 | [纯 UI / 配置类模块清单](#六纯-ui--配置类模块清单) |
| 七 | [MY_!Base 公共 API 全览](#七my_base-公共-api-全览) |
| 八 | [数据文件总览速查表](#八数据文件总览速查表) |
| 九 | [对 JX3 Raid Manager 项目的应用价值](#九对-jx3-raid-manager-项目的应用价值) |
| 十 | [局部分析局限与未确认项](#十局部分析局限与未确认项) |
| 附录 A | [关键源码文件路径索引](#附录-a关键源码文件路径索引) |
| 附录 B | [MSG 类型常量速查](#附录-bmsg-类型常量速查) |
